...
def carrito(request):
    producto_ids_1 = [3,4,5]  # Primer conjunto de productos
...
#PROBANDO PARA PODER GUARDAR PRODUCTOS A LA BASE DE DATOS NUEVA CARRITO.

def guardar_carrito(request):
    if request.method == 'POST':
        # Aquí va la lógica para guardar el carrito en la base de datos
        # Por ejemplo, puedes iterar sobre los items en el carrito y guardarlos
        # ...
        return redirect('carrito')  # Redirige de nuevo a la página del carrito después de guardar
